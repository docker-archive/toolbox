...
Name: "{userprograms}\Docker\Docker Quickstart Terminal"; WorkingDir: "{app}"; Filename: "{app}\docker-start.cmd"; IconFilename: "{app}/docker-quickstart-terminal.ico"; Components: "Docker"
